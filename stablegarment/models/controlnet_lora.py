# adapted from https://github.com/HighCWu/control-lora-v2/blob/master/models/control_lora.py
...
from .utils import _tie_weights
...
class ControlLoRAModel(ControlNetModel):
    ...
    def from_unet(
        ...
        # disable this one, we always need to tie weight explictly outside the function
